using RezervasyonSistemi.OAuth.Providers;
...
[assembly: OwinStartup(typeof(RezervasyonSistemi.OAuth.Startup))]
...
namespace RezervasyonSistemi.OAuth
{
    public class Startup
    {
        ...
        private void ConfigureOAuth(IAppBuilder appBuilder)
        {
            ...
            {
                TokenEndpointPath = new Microsoft.Owin.PathString("/api/Login"), // token alacağımız path'i belirtiyoruz
